...
def log_init():
    ...
    handlers = [
        ...
        RotatingFileHandler(LOG_FILE, mode='a', maxBytes=10 * 1024 * 1024, backupCount=5, encoding='utf-8',
                            delay=False),
...
def send_mq(connection, message):
    try:
...
def callback(channel, method, properties, body):
    try:
        ...
        send_mq(send_connection, send_message)
    except Exception as e:
        channel.close()
        logger.error(repr(e))
